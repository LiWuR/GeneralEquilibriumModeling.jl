# gemb_CD_endogenousClaimRate_nc3_na3_v1

Source file: `examples/gemb_CD_endogenousClaimRate_nc3_na3_v1.jl`

````julia
# ================================================================
# gemb_CD_endogenousClaimRate_nc3_na3_v1.jl
#
# High-level GEMB example: Cobb--Douglas equilibrium with an
# endogenous ad valorem claim rate represented by a virtual agent.
#
# No GEMB claim-rate machinery is used by the firm. Instead:
#
#   1. taxRateSetter is a virtual agent whose activity variable is tau;
...
#
# The activity variable of this virtual agent IS the endogenous
# ad valorem claim rate:
#
#     activity = tau.
#
# Its condition is
...
#
# The virtual agent has zero net supply. It formally produces and
# demands the same amount of prod, so its commodity contribution
# cancels identically.
#
# The lower bound permits a negative subsidy rate. The selected
# benchmark has tau = -1/6, safely inside the bounds.
# ----------------------------------------------------------------
...
tax_rate_setter_spec = ActivityDemandSpec(
    (
        ...
        # Demand exactly offsets the virtual output.
        return [activity]
    end;
